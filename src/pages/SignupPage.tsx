          ...
          <div className="sm:mx-auto sm:my-auto sm:w-full sm:max-w-sm ">
            ...
            <div className="mt-8">
              <form className="space-y-6" onSubmit={onSubmit}>
                ...
                <div>
                  <button className="flex w-full justify-center rounded-md bg-[--primary] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-[--primary-hover] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                    Registrarme
                  </button>
